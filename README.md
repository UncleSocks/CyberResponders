...
The goal of the game is to provide an entertaining way to familiarize users with basic Windows CMD commands while being in the shoes of an incident responder. 
